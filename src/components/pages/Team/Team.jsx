...
const Team = () => {
    ...
    const columns = [
        ...
        { field: "name", headerName: "name", align: "center", flex: 1, headerAlign: "center", },
        ...
        { field: "phone", headerName: "phone", flex: 1, align: "center", headerAlign: "center", },
        {
            ...
            renderCell: ({ row: { access } }) => {
                ...
                return (
                    <Box sx={{ backgroundColor: access === "Admin" ? theme.palette.primary.dark : access === "Manager" ? theme.palette.secondary.dark : "#3da58d", padding: "7px", borderRadius: "6px", color: "white", display:"flex" , justifyContent:"space-evenly",width:"110px" }}>
                        {access === "Admin" && (
                            <AdminPanelSettingsOutlined  sx={{fontSize:"20px"}}/>
                        )}
                         {access === "Manager" && (
                            <SecurityOutlined  sx={{fontSize:"20px"}} />
                        )}
                         {access === "User" && (
                            < LockOpenOutlined  sx={{fontSize:"20px"}}/>
                        )}
    ...
    return (
        <>
            ...
            <Box sx={{ height: 590, width: '99%', mx: "auto" }}>
